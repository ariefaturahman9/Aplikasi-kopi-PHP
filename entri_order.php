...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <?php
      if($r['id_level'] == 1 || $r['id_level'] == 2 || $r['id_level'] == 3 || $r['id_level'] == 5){
    ?>
      <p></p>
      <?php
        $order = array();
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $no_order_fiks = 1;
                  $query_order_fiks = "select * from tb_pesan natural join tb_menu where id_user = $id and status_pesan != 'sudah'";
    ...
    <div class="row-fluid">
              ...
              <div class="btn-icon-pg">
                <ul>
                  ...
                  <?php
                    ...
                    $query_data_makanan = "select * from tb_menu where stok > 0 order by id_masakan desc";
                  ...
                  ?>
                    ...
                    $query_tambah_pesan = "INSERT INTO tb_pesan (id_pesan, id_user, id_order, id_masakan, jumlah, status_pesan) 
                       VALUES (NULL, '$id', '', '$id_masakan', '', '')";
      ...
      <?php
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $query_ubah_jumlah = "select * from tb_pesan left join tb_menu on tb_pesan.id_masakan = tb_menu.id_masakan where id_user = $id and status_pesan != 'sudah'";
            ...
            while($r_ubah_jumlah = mysqli_fetch_array($sql_ubah_jumlah)){
              ...
              $query_stok = "select * from tb_menu where id_masakan = $tahu";
              ...
              $query_kurangi_stok = "update tb_menu set stok = $sisa_stok where id_masakan = $tahu";
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Rie <a href="#"> Coffe </a> </div>
</div>
