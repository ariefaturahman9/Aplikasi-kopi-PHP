          ...
          <ul class="thumbnails">
            <div class="btn-icon-pg">
              <ul>
                <!--Looping-->
                <?php
                  $query_data_makanan = "select * from tb_menu order by id_masakan desc";
                ...
                ?>
                  ...
                  <?php
                    ...
                    if(isset($_REQUEST['hapus_menu'])){
                      ...
                      $query_lihat = "select * from tb_menu where id_masakan = $id_masakan";
                      ...
                      $query_hapus_masakan = "delete from tb_menu where id_masakan = $id_masakan";
