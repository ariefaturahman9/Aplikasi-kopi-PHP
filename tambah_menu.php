...
if(isset ($_SESSION['username'])){
  ...
  if(isset($_SESSION['edit_menu'])){
    ...
    $query_data_edit = "select * from tb_menu where id_masakan = $id";
        ...
        <div class="widget-content" >
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                ?>
                  ...
                  <input name="nama_masakan" type="hidden" value="<?php echo $nama_masakan; ?>" class="span11" placeholder="Nama Menu"/>
                <?php
                  } else {
                ?>
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              //echo "<br></br>";
              $query_tambah_masakan = "insert into tb_menu values ('','$nama_masakan','$harga','$stok','$status_masakan','$gambar')";
            ...
            if(isset($_POST['ubah_menu'])){
              ...
              $query_ubah_masakan = "update tb_menu set nama_masakan = '$nama_masakan', harga = '$harga', stok = '$stok', status_masakan = '$status_masakan' where id_masakan = '$id_masakan'";;
              ...
              if($gbr != "" || $gbr != null){
                ...
                $query_ubah_gambar = "update tb_menu set gambar_masakan = '$gambar' where id_masakan = '$id_masakan'";;
