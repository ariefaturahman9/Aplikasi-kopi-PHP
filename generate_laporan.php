                  ...
                  <td>
                    <center>
                      <?php
                        ...
                        $query_lihat_stok = "select * from tb_stok left join tb_pesan on tb_stok.id_pesan = tb_pesan.id_pesan left join tb_menu on tb_pesan.id_masakan = tb_menu.id_masakan where status_cetak = 'belum cetak'";
